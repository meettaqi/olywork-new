...
This plugin ships the skill, so you have this page — but not yet the `olywork` command, and not yet its
...
olywork mcp install                             # 3. register olywork's tools into this agent
```
