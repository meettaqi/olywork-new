...
```bash
git clone https://github.com/meettaqi/olywork-new
cd olywork
...
sqlite). The `OLYWORK_*` knobs for persistence / a real deployment are documented in the README's
...
- `src/olywork/` — the app (FastAPI API, proxy, CLI, runners). The **design docs** in `docs/context/` explain
