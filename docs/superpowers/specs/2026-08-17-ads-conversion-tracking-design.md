# Google Ads conversion tracking for olywork — design

**Date:** 2026-08-17
**Branch:** `feat/ads-conversion-tracking`
**Ads account:** `5149790776` ("Olywork"), AUD, `Australia/Sydney`, client of the Shirley Lou MCC (`3519125194`)

## The problem

olywork has no analytics instrumentation of any kind — no `gtag`, GTM, GA, PostHog or Plausible, in the
...
| Top-up counting | once per org, not per payment | optimises for acquiring payers; value-based bidding needs volume olywork does not have yet |
...
- **`wiki/topics/olywork.com SEO.md` §9 (2026-08-17) states "No ads for olywork"**, on the grounds that the
...
|---|---|---|---|---|
| `7723667014` | olywork Signup | `UPLOAD_CLICKS` | `SIGNUP` | no |
| `7723667017` | olywork First successful call | `UPLOAD_CLICKS` | `QUALIFIED_LEAD` | **yes** |
| `7723667020` | olywork First top-up | `UPLOAD_CLICKS` | `PURCHASE` | **yes** |
