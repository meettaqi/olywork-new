...
KEY = "7c2e4a91b5d3f8e6olywork2026"  # must match INDEXNOW_KEY in src/olywork/routers/web.py


def main() -> int:
    ap = argparse.ArgumentParser()
    ap.add_argument("--base", default="https://olywork.com")
    ...
    #   olywork call google-search-console.x.webmasters-sitemaps-submit --method PUT \
    #     --query siteUrl=sc-domain:olywork.com --query feedpath=https://olywork.com/sitemap.xml
