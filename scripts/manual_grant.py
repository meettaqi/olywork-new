...
whatever `src/olywork/models.py` the checkout has. A branch carrying an unmigrated column makes the
...
async def run(args) -> int:
    ...
    from olywork.models import CreditBlock, LedgerEntry, Membership, Org, User
