...
def _view(s: Secret) -> dict:
    # Expiry rides alongside status because they answer different questions. A credential olywork
...
def needs_reconnect(s: Secret) -> bool:
    """A credential heading for silent death: olywork can't renew it and it's expiring or gone.
