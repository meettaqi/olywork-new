...
reach unpkg got a blank signed-in dashboard and no error — [#137](https://github.com/meettaqi/olywork-new/issues/137).
...
```bash
V=3.6.0
curl -sSLo src/olywork/web/vendor/vue-$V.global.prod.js https://unpkg.com/vue@$V/dist/vue.global.prod.js
...
cmp /tmp/vue-check.js src/olywork/web/vendor/vue-$V.global.prod.js && echo OK
```
