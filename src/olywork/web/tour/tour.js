 ...
 * native in-dashboard view (web/index.html). window.OLYWORK_TOUR.steps = [{part,who,img,title,explain,notice}].
  ...
  window.OLYWORK_TOUR = {
    ...
    steps: [
      ...
      { part:"Bring people in", who:"tom", img:"06-invite.webp", title:"Invite a teammate",
        explain:"Enter a teammate's email, pick a role (viewer / member / admin), and <b>Invite</b>. olywork mints a <b>one-time code</b> shown inline (with a copy button). They can also accept it code-free — the invite is tied to their email.",
      ...
      { part:"Register resources", who:"bob", img:"13-skill.webp", title:"Register a skill (bundle)",
        explain:"A <b>skill</b> = a recipe + its secrets + its tool(s), registered atomically as a <b>bundle</b>. Click <b>+ Skill</b> and paste the payload (secret values go inline here; the CLI's <code>olywork.json</code> loads them from files instead).",
      ...
      { part:"Use tools", who:"alice", img:"15-try-it.webp", title:"Try it — key injected",
        ...
        notice:"This is the whole product: call the real API through olywork, and the secret is added on the server. Even a <b>viewer</b> can do this." },
