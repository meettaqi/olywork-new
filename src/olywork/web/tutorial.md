...
- **Import & shell** → `https://olywork.com/tutorial-import-shell.md` — `olywork upload clis` turns the
  CLIs already on your machine into team tools; `olywork shell` opens a shell where `stripe`, `gh`, `gcloud` …
...
olywork calls [--limit N]                          # the audit log
