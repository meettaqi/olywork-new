...
One symmetric key (OLYWORK_SECRET_KEY). The proxy decrypts only at call time, in memory,
...
# won't survive a restart, which is the intended loud signal to set OLYWORK_SECRET_KEY).
...
def new_key() -> str:
    """A fresh urlsafe key for OLYWORK_SECRET_KEY."""
