...
async def call_tool(
    ...
    # Identity for the refusal fallback in `_mark_olywork_own_errors`: a raise anywhere below (unknown
    ...
    try:
        ...
        # this olywork-owned failure is represented once in the same funnel as normal call outcomes.
