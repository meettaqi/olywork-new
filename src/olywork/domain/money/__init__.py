...
async def reserve(
    ...
    `tags` is the caller's `X-Olywork-Meta` bag. An EXPLICIT parameter, never read out of `meta`: what a
...
async def reserve_in_transaction(
    ...
    # ledger entries, the audit row and the X-Olywork-Call-Id the caller gets back.
