/**
 * olywork as a DeepSeek Harness (dsh) plugin.
 *
 * Registers one `ctx.skills` provider that publishes the generated
 * `dsh/skills/olywork/SKILL.md`. The MCP connector is NOT here: it is a separate
 * row in `cordis.patch.yml`, disabled until `OLYWORK_TOKEN` exists, so the skill
...
const PROVIDER_NAME = 'olywork'
const SKILL_NAME = 'olywork'
/** Rank of the `bundled` discovery source in dsh's own skill provider. */
const BUNDLED_SKILL_RANK = 600

const SKILL_DIR_URL = new URL('./skills/olywork/', import.meta.url)
 ...
 *
 * SKILL.md is generated from `src/olywork/web/skill.md`, which is the one source
 * for how olywork describes itself. Restating the description here would be a
...
/** Cordis plugin name. */
export const name = 'olywork-skill'
/** The registry this plugin contributes to. */
export const inject = ['skills']

/**
 * Register the packaged olywork skill on `ctx.skills`.
 *
