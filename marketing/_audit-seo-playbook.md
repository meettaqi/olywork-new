...
| # | Tactic | Verdict |
|---|---|---|
| 1 | Self-promotional "best X" ranking our own brand first | **Clear.** The comparison ranks *providers*; olywork.com is the access layer and is not one of the ranked items. This also sidesteps Ray's law 5 (69% of self-promotional listicle citations ended with the citing brand excluded from the recommendation) |
...
| 3 / 7 | Templated scaling with minimal uniqueness | **Near-miss, and the real risk for waves 2 and 3.** 12 pages with hand-written notes and quoted research is fine; 66 generated from the same shell would be the fingerprint Ray describes. The `olywork-page` skill exists to keep the per-page research mandatory |
...
- **Named author** — **still missing.** Indig's data says named authors outperform brand bylines.
  This needs a person's name and is Taqi's call, not something to invent.
...
1. **No off-site presence.** Nothing in this repo fixes it. Indig and Ray converge here: authority is
   ...
   remaining work, and they are Taqi's to send.
