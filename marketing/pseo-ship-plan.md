...
2. `/agents/claude-code` — `olywork mcp install`, screenshot of the terminal after install.
...
- Per-vendor observed stats are approved (Taqi, 2026-08-21) with the "live traffic, not a
