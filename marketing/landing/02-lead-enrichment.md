...
seo_title: "Waterfall Enrichment: Find and Verify Work Emails | olywork.com"      # 53
...
```text
Using olywork, build me a lead list: 50 US software companies with 51 to 200 staff
...
most-called enrichment endpoint on olywork.com: **963 calls at 100% success**. It runs at $0.00625 with
...
*Run on olywork.com, 26 Aug 2026: the full 50-company workflow, one prompt, one key. Every figure is
...
charge in its response, so olywork.com settled their calls at the list rate, misses included: $0.56 of
...
olywork.com adds no markup to what the provider charges. New teams start with $1.00 of free credit: enough
...
Clay is a visual table for GTM workflows. olywork.com is a catalog of the same data providers Clay calls,
...
same (Apollo, Hunter, Clearbit, etc.); the interface is your agent. Clay is not in the olywork.com catalog
because it is a workflow tool, not a data API.

**Is there an Apollo MCP or Hunter MCP?**
Yes. The olywork.com MCP server gives your agent access to Apollo, Hunter and the other enrichment providers
