...
falls back through olywork's own stack (Georgia / system-ui / ui-monospace) instead of
...
CSS = (HERE.parent.parent / "src" / "olywork" / "web" / "usecase.css").read_text()
...
def build(dest):
    ...
    for p in sorted(B.DIST.glob("0*.md")):
        ...
        metas.append(f'''<div class="rmeta" data-for="{pid}"><div class="in">
          <div class="slug">olywork.com/use-cases/{html.escape(slug)}</div>
...
<title>olywork.com Use-Case Pages</title>
<style>{CSS}{REVIEW_CSS}</style>

<div class="rbar"><div class="in">
  <span class="who">olywork.com · use-case pages · review build 17 Aug 2026</span>
