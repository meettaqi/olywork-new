...
seo_title: "Company Research: Funding, Headcount and Leadership | olywork.com"           # 57
...
```text
Using olywork, find 50 AI infrastructure companies that raised a Series A in the last
...
| **Keys** | An account and a contract per data vendor, most of them annual | One olywork token. Every tool in the catalog answers to it |
...
*Run on olywork.com, 17 Aug 2026. Every figure is from the Activity log of that run.*
...
> price. It is also why olywork.com relays your request rather than rewriting it: a system that silently
...
one, connect it and those calls route through your key, unmetered. olywork.com is closer to OpenRouter for
...
shown before the call, and olywork.com adds no markup. New teams start with $1.00 of free credit.

**Is there a Crunchbase MCP?**
This is one. olywork.com is a single MCP server that carries Crunchbase alongside ten other company-search
...
Run `olywork catalog get apollo.companies.search` on camera and let the sibling table render: eleven
providers, prices, success rates, sample sizes. That single screen is the most persuasive thing olywork.com
