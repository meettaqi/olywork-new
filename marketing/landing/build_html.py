...
Writes  src/olywork/web/usecase-<key>.html
...
DIST = HERE / "dist"
WEB = HERE.parent.parent / "src" / "olywork" / "web"
...
# Display name → the slug olywork already serves at /logos/<slug>.svg. The provider tables ARE the
...
# The page said "copy this into Claude Code" while never telling a first-time visitor how olywork gets
...
SETUP_BOX = """<div class="steplabel"><span class="n">1</span><b>Set olywork up in your agent</b>
...
<div class="promptbox">
  ...
  </div><pre id="setup">set up olywork &mdash; https://olywork.com/llms.txt</pre>
</div>
...
def render_hero(body, page_id):
    ...
    for b in bs:
        ...
        if s.startswith("### "):
            ...
            # first cut shipped `<code>text\nUsing olywork…` — the info string and all. Strip it with
...
def generate_jsonld(slug, h1, category):
    ...
    global FAQ_PAIRS
    ld = []
    # BreadcrumbList - note: breadcrumb uses "olywork.com" not bare "olywork"
    ld.append({
...
<div class="navwrap"><nav class="nav">
  <a class="brand" href="/"><span class="glyph">&#9626;</span> olywork.com</a>
  <div class="links">
    <a class="hidem" href="/tutorial">docs</a>
    <a class="hidem" href="https://github.com/meettaqi/olywork-new" target="_blank" rel="noopener">repo</a>
...
<footer>
  <div class="foot-in">
    ...
    <a href="https://github.com/meettaqi/olywork-new" target="_blank" rel="noopener">github &#8599;</a>
...
/* Landing-page instrumentation. The conversion that matters is the FIRST SUCCESSFUL CALL,
   ...
   events are queued on window.olyworkEvents so nothing is silently lost. */
(function(){{
  window.olyworkEvents = window.olyworkEvents || [];
  function ev(name, props){{
    var p = Object.assign({{page: document.body.dataset.page}}, props || {{}});
    window.olyworkEvents.push([name, p, Date.now()]);
...
<meta charset="utf-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<title>Resources: what your agent can do with olywork.com</title>
<meta name="description" content="Worked workflows for olywork.com: SEO and search results, lead enrichment, social research, competitor ads and company data. Each one is a prompt you can copy and run."/>
...
<header class="hero"><div class="wrap">
  ...
  <h1>What your agent can do with olywork.com</h1>
