"""Observed reliability per catalog endpoint — the half of "compare providers" only olywork can answer.
...
async def test_a_olywork_refusal_is_not_evidence_about_the_endpoint(clients: AsyncClient):
