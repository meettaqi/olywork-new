...
import olywork.api as api_mod
from olywork import sandbox
from olywork.application.onboard import pubfeed
from olywork.domain.governance import publicdemo as publicdemo_policy
...
async def _mint(c: AsyncClient) -> dict:
    r = await c.post("/demo/sandbox", headers={"X-Olywork-Token": ""})
