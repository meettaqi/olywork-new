# olywork — black & white logo assets (Twitter / X)

The mark is `▚` — upper-left + lower-right quadrants, the same geometry as
`src/olywork/web/favicon.svg` and `plugin/assets/icon.svg`, recoloured to pure
...
- **The banner mirrors the README hero** (`docs/assets/olywork-hero.png`): the same
...
- Colours are pure `#000000` / `#ffffff`. The brand colour set (clay `#e0703f`
  on `#211d16`) lives in `src/olywork/web/index.html`; these are the mono cut.
